function basesymbol(widget_id, url, skin, parameters)
{
    ...
    function set_view(self, state, level)
    {
        if ("icons" in self.parameters)
        {
            ...
            {
                self.set_field(self, "icon", "http://192.168.0.50:8123/local/moon_icons/" + self.parameters.icons[state].icon);
                self.set_field(self, "icon_style", self.parameters.icons[state].style)
//                self.set_field(self, "icon", "/local/moon_icons/waning_gibbous";
//                self.set_field(self, "icon_style", self.parameters.icons[state].style)
//                self.set_field(self, "icon_style", "color: white")
//                self.set_field(self, "icon", "fa-circle-thin");
//                self.set_field(self, "icon_style", "color: white")
            }
            else if ("default" in self.parameters.icons)
            {
                self.set_field(self, "icon", "../../custom_css/" + self.parameters.icons.default.icon);
